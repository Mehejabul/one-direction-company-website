...
@section('content')
    <!-- Breadcrumbs Block -->
		...
		<div class="block">
			<div class="container">
				<h2 class="text-center h-lg h-decor">Our previous work gallery Gallery</h2>
				<div class="text-center max-800">
					<p class="p-lg">In our gallery, you can find images showing the amazing Previous work which are finshed recently.</p>
				</div>
				...
				<div class="gallery-wrap">
					...
					<div class="ondirection_gallery">
						<div class="row">
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery1.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery2.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery3.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery4.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery5.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery6.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery7.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery8.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery9.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
									<img src="{{ asset('images/others/gallery10.jpg') }}" class="img-fluid w-100">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="one_direction_single_image">
